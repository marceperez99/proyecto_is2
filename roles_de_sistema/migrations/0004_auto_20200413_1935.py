# Generated by Django 3.0.4 on 2020-04-13 23:35
...
class Migration(migrations.Migration):
    dependencies = [
        ('roles_de_sistema', '0003_auto_20200402_1543'),
    ]
    ...
    operations = [
        migrations.AlterModelOptions(
            name='roldesistema',
            options={
                'permissions': [('pa_crear_proyecto', 'Crear Proyecto'), ('pa_cancelar_proyecto', 'Cancelar Proyecto'),
                                ...
                                ('pa_editar_rs', 'Editar Rol de Sistema'), ('pa_crear_rp', 'Crear Rol de Proyecto'),
