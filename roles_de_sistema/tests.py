...
@pytest.mark.django_db
def test_roldesistema_lista_de_permisos_vacia():
    """
...
@pytest.mark.django_db
def test_rol_de_sistema_es_utilzado(usuario, rol_de_sistema):
    """
...
@pytest.mark.django_db
def test_rol_de_sistema_no_es_utilzado(rol_de_sistema):
    """
...
@pytest.mark.django_db
def test_eliminar_rol_de_sistema_exito(usuario, rol_de_sistema):
    """
...
@pytest.mark.django_db
def test_eliminar_rol_de_sistema_fallido(rol_de_sistema):
    """
