...
ruptura de linea base.

En la solicitud se deberan especificar los siguientes campos:
...
les parezca, una vez todos hayan votado puede pasar dos cosas:
    ...
    1- Que la solicitud haya sido aprobada, lo que implica lo siguiente:
        ...
        -Los item que no fueron seleccionados para su modificacion pasan al estado "En Revicion", estos item son sometidos a verificacion, donde se verifica si es que necesitan algun cambio. Si no necesitan cambio, pasan al estado anteriror, de lo contrario pasan al estado "A Modificar"
