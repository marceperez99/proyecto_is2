...
pasar de un estado a otro y que se puede hacer con el en ese estado, veremos los estado de los item
    ...
    -En Revisión:
        ...
        estado "En revision", se tiene que comprobar si los item necesitan ser modificados, si necesitan cambios pasan
        al estado "A modificar", sino, pasan a su estado anterior.
    -Eliminado:
